// lyrinka kernal version 1.0.4 
#ifndef __lyrinka_h__
#define __lyrinka_h__
#include <stm32f10x.h>
//////////// 																							// Macro Required: SVCn_lyrinkaTrig, SVCn_lyrinkaSwitch 
...
void lyrinka_ThreadInit(u32 *, void *, u32, u32); 				// User Functions - New Thread Stack Init 
...
__asm void lyrinka_ThreadInit(u32 * funcStk, void * funcPtr, u32 Arg0, u32 Arg1){ // User Functions - New Thread Stack Init 
		PUSH	{R4,LR} 
		LDR		R4, [R0] 
