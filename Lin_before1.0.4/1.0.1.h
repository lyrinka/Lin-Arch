...
void Kernal_StackInit(u32 *, void *, u32, u32); 				// User Functions - New Thread Stack Init 
...
__asm void Kernal_ThreadExit(void){ // Internal Functions - Performs Thread Looping 
		LDR		LR, =Kernal_ThreadExit 
		LDR		R0, [SP] 
		BX		R0 
}
...
Cut																// 2. Match Switch or FinState of OsEnter 
		...
		B			__cpp(Kernal_ISRSwitch) //== Context Switching 
