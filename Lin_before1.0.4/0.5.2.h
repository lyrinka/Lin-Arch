...
__asm void SVC_Handler(void){ // SVC Call Handler 
		...
		BNE		Shut 										// 1A. KernalTrig -> KernalEnter 
...
Shut															// 1B. KernalTrig -> KernalExit 
		...
		LDR		R2, =ptrC 
		STR		R0, [R2] 								//-- ptrC has previous ptrN value		
		MOV		R3,  LR 
